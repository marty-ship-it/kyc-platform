    ...
    <>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">
                    {entity.screenings && entity.screenings.length > 0 ? 
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium">
                    {entity.cases ? entity.cases.filter(c => c.status === 'OPEN' || c.status === 'UNDER_REVIEW').length : 0}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-500">Total Cases</span>
                  <span className="text-sm font-medium">{entity.cases?.length || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-500">Associated Deals</span>
                  <span className="text-sm font-medium">{entity.deals?.length || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-500">Party Roles</span>
                  <span className="text-sm font-medium">{entity.parties?.length || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-500">Transactions</span>
                  <span className="text-sm font-medium">{entity.transactions?.length || 0}</span>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <TabsContent value="cases" className="space-y-4">
          {entity.cases && entity.cases.map((case_) => (
            <Card key={case_.id}>
        ...
        <TabsContent value="kyc" className="space-y-4">
          {entity.parties && entity.parties.map((party) => (
            <Card key={party.id}>
              <CardContent className="p-6">
          ...
          {(!entity.parties || entity.parties.length === 0) && (
            <Card>
              <CardContent className="p-8 text-center">
                <Shield className="w-12 h-12 text-gray-400 mx-auto mb-4" />
